...
#### 🔧 Connaà®tre les colonnes d'un objet en mémoire
...
#### 🔧 Connaà®tre la taille d'un tableau
...
> L'opérateur ``columns`` reà§oit un tableau et retourne la liste des colonnes qu'il contient.
